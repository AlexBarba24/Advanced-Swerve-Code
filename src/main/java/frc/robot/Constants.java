...
public final class Constants {
  public static class OperatorConstants {
    ...
    public static final class CanConstants{
        ...
        public static final int[] FRONT_LEFT_MODULE_STEER_ENCODER = {0,0}; 
        public static final int[] FRONT_RIGHT_MODULE_STEER_ENCODER = {0,0}; 
        public static final int[] BACK_LEFT_MODULE_STEER_ENCODER = {0,0}; 
        public static final int[] BACK_RIGHT_MODULE_STEER_ENCODER = {0,0}; 
